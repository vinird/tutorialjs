var Tutorial={startIndex:0,endIndex:999,selector:'.tutorial',onlyOnce:!1,styles:!0,bodyScroll:!1,removeAnimationConflicts:!1,btnFramework:'semantic',btnFinishText:'Finish',btnFinishClass:'ui button tiny basic',btnNextText:'Next',btnNextClass:'ui button tiny primary',tutorialCount:-999,scrollSelector:null,resolve:null,reject:null,start:()=>{Tutorial.tutorialCount=Tutorial.startIndex;if(Tutorial.removeAnimationConflicts){$('.animated').css('animation','unset')}
